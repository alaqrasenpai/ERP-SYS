...
app.use('/api/inventory', authMiddleware, tenantResolver, inventoryRoutes);
app.use('/api/archive', authMiddleware, tenantResolver, archiveRoutes);
app.use('/api/users', authMiddleware, tenantResolver, usersRoutes);
app.use('/api/hr', authMiddleware, tenantResolver, hrRoutes);
app.use('/api/pos', authMiddleware, tenantResolver, posRoutes);
...
app.use('/api/finance', authMiddleware, tenantResolver, financeRoutes);
