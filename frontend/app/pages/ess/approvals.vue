            ...
            <tr v-for="req in requests" :key="req._id" class="hover:bg-gray-50">
              ...
              <td v-if="!showHistory" class="px-6 py-4 whitespace-nowrap text-end">
                <div class="flex justify-end gap-2">
                  <button @click="openActionModal(req, 'Approved')" class="p-1.5 bg-secondary-50 text-secondary-600 hover:bg-secondary-100 rounded-lg transition-colors" :title="$t('my_leaves.approved')">
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md my-8">
          ...
          <form @submit.prevent="submitAction" class="p-6 space-y-4">
            <div>
              ...
              <textarea v-model="managerNotes" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500"></textarea>
            </div>
            ...
            <div class="pt-4 flex justify-end gap-3">
              ...
              <button type="submit" :disabled="saving" :class="actionType === 'Approved' ? 'bg-secondary-600 hover:bg-secondary-700' : 'bg-red-600 hover:bg-red-700'" class="px-4 py-2 text-white rounded-xl font-bold disabled:opacity-50 transition-colors">
