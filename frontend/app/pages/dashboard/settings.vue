    ...
    <div class="max-w-4xl mx-auto space-y-6">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">Configure your ERP branding, localization, and POS defaults.</p>
        </div>
        ...
        <div class="p-6">
          ...
          <div v-if="activeTab === 'financial'" class="space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">Default Tax Rate (%)</label>
              ...
              <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">Fiscal Year Start (MM-DD)</label>
            ...
            <div class="bg-yellow-50 border border-yellow-200 p-4 rounded-xl flex">
              ...
              <p class="text-sm text-yellow-800 font-medium">Changing the tax rate will affect all future POS transactions. Existing transactions and journal entries will not be modified.</p>
            </div>
          </div>
          ...
          <div v-if="activeTab === 'pos'" class="space-y-6">
            <div>
              <label class="block text-sm font-bold text-gray-700 mb-2">Receipt Header Message</label>
              <textarea v-model="settings.receiptHeader" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500" placeholder="Welcome to our store!"></textarea>
            </div>
            <div>
              <label class="block text-sm font-bold text-gray-700 mb-2">Receipt Footer Message</label>
              <textarea v-model="settings.receiptFooter" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500" placeholder="Thank you for your business. Returns accepted within 14 days."></textarea>
            </div>
            
            <div class="mt-8 p-6 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50">
              <h4 class="text-xs font-black text-gray-500 uppercase tracking-wider mb-4 text-center">Receipt Preview</h4>
              <div class="bg-white max-w-xs mx-auto p-4 rounded shadow-sm font-mono text-xs text-center border-t-8 border-gray-800">
                ...
                <div class="border-t border-dashed border-gray-300 py-2 my-2 flex justify-between font-bold">
                  <span>TOTAL (incl. {{ settings.taxRate }}% tax)</span>
