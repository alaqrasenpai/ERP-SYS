        ...
        <div class="bg-white rounded-xl border border-gray-100 p-6 shadow-sm">
           <div class="flex items-center justify-between">
              <div>
                 ...
                 <p class="text-2xl font-bold text-secondary-600">${{ totalCash.toFixed(2) }}</p>
              </div>
              <div class="p-3 bg-secondary-50 text-secondary-600 rounded-lg">
              ...
              <tr v-for="order in orders" :key="order._id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm">
                  <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full"
                        :class="order.paymentMethod === 'Cash' ? 'bg-secondary-100 text-secondary-800' : 'bg-blue-100 text-blue-800'">
                    {{ order.paymentMethod }}
                  </span>
                </td>
