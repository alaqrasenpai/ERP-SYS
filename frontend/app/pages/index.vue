  ...
  <div class="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
          ...
          <div class="hidden md:flex space-x-8 rtl:space-x-reverse">
            ...
            <a href="#modules" class="text-sm font-bold text-gray-500 hover:text-indigo-600 transition-colors">Modules</a>
            <a href="#contact" class="text-sm font-bold text-gray-500 hover:text-indigo-600 transition-colors">Contact</a>
          </div>
          <div class="flex items-center">
            <!-- If they have an existing session, we could link to dashboard, but landing is generic. We just let them use their specific URL. -->
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative pt-20 pb-24 lg:pt-32 lg:pb-40">
        <div class="text-center max-w-4xl mx-auto">
          <h1 class="text-5xl md:text-7xl font-black text-gray-900 tracking-tight leading-tight mb-8">
            The Ultimate <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Enterprise</span> Management System
          </h1>
          <p class="text-lg md:text-xl text-gray-500 font-medium mb-12 max-w-2xl mx-auto leading-relaxed">
            Unify your HR, Accounting, Inventory, POS, and Restaurant operations in one powerful, cloud-based platform designed for scale.
          </p>
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <button @click="promptStoreLogin" class="px-8 py-4 bg-gray-900 hover:bg-black text-white rounded-2xl font-bold text-lg shadow-xl shadow-gray-200 transition-all flex items-center justify-center">
              Access Your Workspace
              <svg class="w-5 h-5 ms-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </button>
          </div>
        </div>
      </div>
    ...
    <div id="features" class="py-24 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl font-black text-gray-900 tracking-tight">Everything you need to grow</h2>
          <p class="text-gray-500 mt-4 font-medium">Modular architecture means you only use what you need.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-3">Smart Accounting</h3>
            <p class="text-gray-500 leading-relaxed text-sm">Automated general ledgers, trial balances, and financial reporting with multi-currency support.</p>
          </div>
          ...
          <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-3">Modern HRMS</h3>
            <p class="text-gray-500 leading-relaxed text-sm">Manage payroll, attendance, leave requests, and employee structures seamlessly.</p>
          </div>
          ...
          <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-3">Retail & POS</h3>
            <p class="text-gray-500 leading-relaxed text-sm">Lightning-fast point of sale with offline capabilities, shift management, and barcode scanning.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="bg-white border-t border-gray-100 py-12 mt-auto">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p class="text-gray-400 font-medium text-sm">© {{ new Date().getFullYear() }} ERPSYS. All rights reserved.</p>
      </div>
    </footer>
  </div>
</template>
...
const promptStoreLogin = () => {
  const storeId = prompt('Enter your Store ID / Workspace Name:')
