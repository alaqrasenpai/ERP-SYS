  ...
  <div class="min-h-screen bg-gray-50 flex flex-col">
    ...
    <div class="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 flex flex-col lg:flex-row gap-8">
      ...
      <div class="flex-1 flex flex-col space-y-8">
        ...
        <!-- Header -->
        <div>
          <h2 class="text-2xl font-black text-gray-900 tracking-tight">Command Center</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm relative overflow-hidden">
              ...
              <div class="flex justify-between items-start mb-4">
                ...
                <span class="text-xs font-bold text-gray-500 uppercase">Today's Revenue</span>
              </div>
              <h3 class="text-3xl font-black text-gray-900">${{ metrics.todayRevenue.toFixed(2) }}</h3>
              <p class="text-xs text-emerald-600 font-bold mt-2">Month: ${{ metrics.monthRevenue.toFixed(2) }}</p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm relative overflow-hidden">
              ...
              <div class="flex justify-between items-start mb-4">
                ...
                <span class="text-xs font-bold text-gray-500 uppercase">Low Stock Alerts</span>
              </div>
              ...
              <NuxtLink to="/dashboard/inventory" class="text-xs text-indigo-600 hover:text-indigo-800 font-bold mt-2 inline-flex items-center">
                View Inventory <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
              </NuxtLink>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm relative overflow-hidden">
              ...
              <div class="flex justify-between items-start mb-4">
                ...
                <span class="text-xs font-bold text-gray-500 uppercase">Active Staff</span>
              </div>
              <h3 class="text-3xl font-black text-gray-900">{{ metrics.totalEmployees }}</h3>
              <p class="text-xs text-gray-500 font-medium mt-2">Mth Payroll: <span class="font-bold text-gray-800">${{ metrics.projectedPayroll.toFixed(2) }}</span></p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm relative overflow-hidden">
              ...
              <NuxtLink to="/dashboard/archive" class="text-xs text-indigo-600 hover:text-indigo-800 font-bold mt-2 inline-flex items-center">
                Open Drive <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
              </NuxtLink>
            </div>
          </div>
          ...
          <div class="mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <NuxtLink to="/dashboard/archive" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-purple-500 hover:shadow-md transition-all text-center">
                ...
                <h4 class="font-bold text-gray-900">Archive</h4>
              </NuxtLink>

              <!-- Finance & CRM -->
              <NuxtLink to="/dashboard/customers" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-pink-500 hover:shadow-md transition-all text-center">
              ...
              <NuxtLink to="/dashboard/accounting" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-yellow-500 hover:shadow-md transition-all text-center">
                ...
                <h4 class="font-bold text-gray-900">Accounting Ledger</h4>
              </NuxtLink>

              <NuxtLink to="/dashboard/checks" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-teal-500 hover:shadow-md transition-all text-center">
                ...
                <h4 class="font-bold text-gray-900">Check Payments</h4>
              </NuxtLink>

              <NuxtLink to="/dashboard/installments" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-cyan-500 hover:shadow-md transition-all text-center">
                ...
                <h4 class="font-bold text-gray-900">Installments</h4>
              </NuxtLink>
              ...
              <NuxtLink to="/dashboard/stock-movements" class="group bg-white p-5 rounded-2xl border border-gray-200 hover:border-lime-500 hover:shadow-md transition-all text-center">
                ...
                <h4 class="font-bold text-gray-900">Stock Audit</h4>
              </NuxtLink>
            </div>
          </div>
        </template>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex-1 flex flex-col">
          ...
          <div class="p-5 flex-1 overflow-y-auto">
            <div class="relative border-l-2 border-gray-100 ml-3 space-y-6">
              ...
              <div v-for="order in activities.orders" :key="order._id" class="relative pl-6">
                <span class="absolute -left-[11px] top-1 w-5 h-5 rounded-full bg-emerald-100 border-2 border-white flex items-center justify-center">
                  <div class="w-2 h-2 rounded-full bg-emerald-500"></div>
                </span>
                <p class="text-sm font-bold text-gray-900">POS Sale: {{ order.orderNumber }}</p>
                <p class="text-xs text-gray-500">{{ new Date(order.createdAt).toLocaleString() }} - Revenue: ${{ order.grandTotal.toFixed(2) }}</p>
              </div>

              <div v-for="file in activities.files" :key="file._id" class="relative pl-6">
                <span class="absolute -left-[11px] top-1 w-5 h-5 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center">
                  <div class="w-2 h-2 rounded-full bg-blue-500"></div>
                </span>
                <p class="text-sm font-bold text-gray-900">Archived Document</p>
                <p class="text-xs text-gray-500">{{ new Date(file.createdAt).toLocaleString() }} - File: {{ file.filename }}</p>
              </div>

              <div v-for="movement in activities.movements" :key="movement._id" class="relative pl-6">
                <span class="absolute -left-[11px] top-1 w-5 h-5 rounded-full bg-orange-100 border-2 border-white flex items-center justify-center">
                  <div class="w-2 h-2 rounded-full bg-orange-500"></div>
                </span>
                <p class="text-sm font-bold text-gray-900">Stock {{ movement.type === 'in' ? 'Added' : 'Deducted' }}</p>
              ...
              <div v-if="!activities.orders?.length && !activities.files?.length && !activities.movements?.length" class="text-sm text-gray-500 ml-6">
                No recent activity.
              </div>
