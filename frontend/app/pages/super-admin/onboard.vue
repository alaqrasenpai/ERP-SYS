  ...
  <div class="p-4 sm:p-8">
    <div class="max-w-4xl mx-auto">
      <div class="flex items-center mb-8">
        <NuxtLink to="/super-admin" class="me-4 p-2 bg-white rounded-lg border border-gray-100 text-gray-500 hover:text-gray-900 shadow-sm transition-colors">
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="pt-4">
              ...
              <div class="flex flex-wrap gap-3">
                <label v-for="mod in availableModules" :key="mod.id" class="flex items-center p-3 bg-gray-50 border border-gray-100 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                  ...
                  <span class="ms-2 text-sm font-bold text-gray-700">{{ mod.label }}</span>
                </label>
              </div>
            </div>
          </div>
