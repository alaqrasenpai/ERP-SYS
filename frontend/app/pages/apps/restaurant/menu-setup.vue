    ...
    <div class="max-w-7xl mx-auto space-y-6">
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
          <NuxtLink to="/apps/restaurant/categories" class="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:bg-gray-50 dark:bg-gray-900 transition font-bold flex items-center gap-2">
