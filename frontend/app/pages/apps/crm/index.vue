  ...
  <div class="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
      <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Customer relationship and sales overview.</p>
      </div>
      <div class="flex items-center gap-2">
        <span class="text-sm font-bold px-3 py-1.5 bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400 rounded-lg">This Month</span>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
        ...
        <div class="flex justify-between items-start relative z-10">
          <div>
            <p class="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1">Total Customers</p>
            <h3 class="text-3xl font-black text-gray-900 dark:text-white">4,821</h3>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
        ...
        <div class="flex justify-between items-start relative z-10">
          <div>
            <p class="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1">Sales Volume</p>
            <h3 class="text-3xl font-black text-gray-900 dark:text-white">1,204</h3>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
        ...
        <div class="flex justify-between items-start relative z-10">
          <div>
            ...
            <h3 class="text-2xl font-black text-gray-900 dark:text-white whitespace-nowrap">45,000 <span class="text-sm text-gray-400">SAR</span></h3>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
        ...
        <div class="flex justify-between items-start relative z-10">
          <div>
            <p class="text-sm font-bold text-gray-500 dark:text-gray-400 mb-1">Churn Rate</p>
            <h3 class="text-3xl font-black text-gray-900 dark:text-white">2.4%</h3>
          </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-lg font-black text-gray-900 dark:text-white tracking-tight">Top Customers</h2>
          <NuxtLink to="/apps/crm/customers" class="text-sm font-bold text-indigo-600 hover:text-indigo-700">View All</NuxtLink>
        </div>
        <div class="space-y-4">
          <div v-for="i in 4" :key="i" class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700">
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-bold text-gray-900 dark:text-white text-sm">Customer Company {{i}}</p>
                <p class="text-xs text-gray-500 font-medium">B2B • Joined 2023</p>
              </div>
            </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 class="text-lg font-black text-gray-900 dark:text-white tracking-tight">Recent Sales History</h2>
          <NuxtLink to="/apps/crm/sales-history" class="text-sm font-bold text-indigo-600 hover:text-indigo-700">Explore</NuxtLink>
        </div>
        <div class="space-y-4">
          <div v-for="i in 4" :key="i" class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-100 dark:border-gray-700">
            <div class="flex items-center gap-3">
